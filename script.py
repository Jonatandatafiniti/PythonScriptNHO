import requests       # type: ignore # Imports the requests library to handle HTTP requests
...
# Define the date range for which data will be fetched
start_date = datetime.date(2024, 12, 31)  # Start date: December 27, 2024
end_date = datetime.date(2025, 1, 31)     # End date: January 27, 2025
...
with open('nho_transactions.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(['Date', 'Number of NHO Transactions'])
